...
import {
  ...
  getAllTweets,
  getAllUsers,
  getRoles, setUserRoleByAdmin, unlockUserByAdmin
} from "../../services/api";
...
class AdminPanel {
  ...
  public async showTweets(reset: boolean = false) {
  ...
  public async showUsers(reset: boolean = false) {
  ...
  public async roles(reset: boolean = false): Promise<IRoles> {
  ...
  public async getUsers(reset: boolean = false): Promise<IUserInfo[]> {
  ...
  public async getTweets(reset: boolean = false): Promise<IUserTweet[]> {
