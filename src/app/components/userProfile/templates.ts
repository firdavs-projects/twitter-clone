class UserProfileTemplates {
    public createUser = (name: string, lastName: string, username: string, id: string, date: string) => {
        ...
        <div class="head-part">
          ...
          <button class="edit-user-button btn btn-primary btn-sm" data-id="${id}" data-bs-toggle="modal" data-bs-target="#editBackdrop">Edit profile</button>
    ...
    public createModalForm = (body: string, id: string) => {
        return `<div class="modal fade" id="${id}" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    public editBody = () => {
      ...
      <input type="text" class="form-control edit-username" id="floatingUsername" placeholder="Username">
      <label for="floatingUsername">Username</label>
    </div>
    <div class="form-floating edit-container">
      <input type="text" class="form-control edit-name" id="floatingName" placeholder="FirstName">
      <label for="floatingName">FirstName</label>
    </div>
    <div class="form-floating edit-container">
      <input type="text" class="form-control edit-surname" id="floatingLastName" placeholder="LastName">
      <label for="floatingLastName">LastName</label>
    </div>
    <div class="form-floating edit-container">
      <input type="text" class="form-control edit-phone" id="floatingPhone" placeholder="Phone">
