export default function footerTemplate(): string {
  return `
<footer class="border-top mt-auto mt-4" style="z-index: 100">
  <div class="container d-flex flex-wrap justify-content-between align-items-center py-3">
    <p class="col-md-4 mb-0 text-muted p-2">© 2022 Twitter Clone by <a href="https://rs.school/js/">RS School</a> students</p>
    ...
    <ul class="nav col-md-4 justify-content-end">
      ...
      <li class="nav-item"><a href="https://github.com/gavrilenkoartem038" class="nav-link px-2 text-muted">@gavrilenkoartem038</a></li>
      <li class="nav-item"><a href="https://github.com/Res1dentEvil" class="nav-link px-2 text-muted">@Res1dentEvil</a></li>
    </ul>
  </div>
</footer>
`;
